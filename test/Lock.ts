...
// interface Fixture {
//   lock: Lock & { deploymentTransaction: () => ContractTransactionResponse }
//   unlockTime: number
//   lockedAmount: number
...
//   async function deployOneYearLockFixture (): Promise<Fixture> {
...
//     if (owner === undefined || otherAccount === undefined) {
